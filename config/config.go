...
func (c *Config) IsFileInScope(file *ast.File) bool {
	if c.IsTemplGeneratedFile(file) {
		return true
	}
...
// IsTemplGeneratedFile returns true if the file is generated by [templ].
//
// [templ]: https://github.com/a-h/templ
func (c *Config) IsTemplGeneratedFile(file *ast.File) bool {
	return asthelper.DocContains(file, "Code generated by templ")
}
