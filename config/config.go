...
func (c *Config) IsFileInScope(file *ast.File) bool {
	...
	for _, exclude := range c.excludeFileDocStrings {
		if asthelper.DocContains(file, exclude) && !(c.EnableTemplSupport && asthelper.DocContains(file, "Code generated by templ")) {
			return false
		}
	}
...
const (
	...
	EnableTemplSupportFlag    = "enable-templ-support"
...
func newFlagSet() flag.FlagSet {
	...
	_ = fs.Bool(EnableTemplSupportFlag, true, "Enable support for templ")
...
func run(pass *analysis.Pass) (any, error) {
	...
	if enableTemplSupport, ok := pass.Analyzer.Flags.Lookup(EnableTemplSupportFlag).Value.(flag.Getter).Get().(bool); ok {
		conf.EnableTemplSupport = enableTemplSupport
	}
